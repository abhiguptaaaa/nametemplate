...
export const metadata: Metadata = {
  title: "XCanvas - Professional Template Design Platform",
  description: "Create stunning certificates, ID cards, and custom templates with XCanvas. Professional design made simple.",
};
