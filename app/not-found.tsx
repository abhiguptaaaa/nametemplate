...
export default function NotFound() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/30 to-purple-50/30 dark:from-slate-900 dark:via-indigo-950/30 dark:to-purple-950/30 flex items-center justify-center p-4 font-sans">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-[-10%] right-[10%] w-[400px] h-[400px] bg-cyan-100/40 dark:bg-cyan-900/20 rounded-full blur-[80px] opacity-50 mix-blend-multiply dark:mix-blend-lighten animate-blob animation-delay-4000" />
            </div>
            ...
            <div className="relative z-10 max-w-2xl w-full text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
                    ...
                    <button
                        ...
                        className="px-8 py-4 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 border-2 border-slate-200 dark:border-slate-700 hover:border-indigo-300 dark:hover:border-indigo-500 font-semibold rounded-full transition-all flex items-center gap-2 active:scale-95"
                    >
